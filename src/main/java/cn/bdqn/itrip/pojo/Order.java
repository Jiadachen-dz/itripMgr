...
public class Order {
    ...
    public Order(Integer userId, Integer orderType, String orderNo, String tradeNo, Integer roomId, Integer count, Long bookingDays, String checkInDate, String checkOutDate, Integer orderStatus, Double payAmount, String noticePhone, String linkUserName) {
        this.userId = userId;
