...
public class Hotel {
    ...
    public Hotel(Integer id, String hotelName, Integer countryId, Integer provinceId, Integer cityId, String address, String hotLine, String details, Integer hotelType, Integer hotelLevel, String facilities, String hotelPolicy, Integer isGroupPurchase, Integer createdBy, Date creationDate, Integer modifiedBy, Date modifyDate, String imgSrc, String countryName, List<RoomType> roomTypes, Double minPriceRoom) {
        this.id = id;
        this.hotelName = hotelName;
        this.countryId = countryId;
        this.provinceId = provinceId;
